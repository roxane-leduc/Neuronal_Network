...
public:
    ...
    */
    ...
    /**
    @brief Ajouter une ligne un à la fin de la matrice this
    */
    void ajouterLigneUn();
    ...
    */
    Matrix apply_function(double(*function)(double));

    void emplace_back(Matrix& f);
    friend Matrix& softmax(Matrix & x);
    friend void calculerDelta(Layer& L);
